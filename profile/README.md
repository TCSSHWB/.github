...
1. **技術局限與現況授權（AS-IS）**：本專案（含組織內所有相關專案與原始碼）皆為學生社員自學之階段性基礎開發成果。本專案依據 **MIT 許可證**，以**現況（AS-IS）**提供原始碼與授權。原創團隊**不保證**程式碼之完全無誤、不保證無資安漏洞，亦**不承擔**任何後續無償維護、錯誤修正、技術支援、升級或永久營運之義務。
2. **營運責任切割與損害賠償免責**：原創開發團隊僅負責「初期之基礎系統建置與技術交接」。本系統一經交付或由後續團隊 fork/複製使用後，其正式部署、上線營運、資料庫管理、功能修改、以及因系統運作中斷、故障、資料遺失、第三方侵權等所衍生之任何**直接、間接、附帶或懲罰性之損害與經濟損失**，原創開發團隊及其成員**一概不負任何賠償或法律責任**。
3. **個資法規範與法律責任承擔**：本系統營運期間所涉及之觀眾個人資料，其**「蒐集、處理及利用」**之一切行為（包含但不限於隱私權政策擬定、個資安全維護措施、外洩通知及法定保存期限屆滿後之銷毀等），**完全由「當屆社團營運幹部、活動負責人及該屆網頁實際操作與維護人員」依《中華民國個人資料保護法》及相關法規自行承擔法律責任**，與原創開發者完全無關。
